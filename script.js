window.onload = () => {
    ...
    const normalSongs = [
        ...
        { title: "19", src: "songs/19.mp3", number: 2 },
        { title: "20", src: "songs/20.mp3", number: 3 },
        { title: "67", src: "songs/67.mp3", number: 1 },
        { title: "32a", src: "songs/32a.mp3", number: 4 },
        { title: "300", src: "songs/300.mp3", number: 3 },
        { title: "6 (ghostnotelin)", src: "songs/6.mp3", number: 2 },
        { title: "Breathing Tube", src: "songs/breathingTube.mp3", number: 3 },
        { title: "FernsKit", src: "songs/dreamkit.mp3", number: 1 },
        { title: "God (Fefi)", src: "songs/fefigod.mp3", number: 4 },
        { title: "Piss (Fefi)", src: "songs/fefiPiss.mp3", number: 1 },
        { title: "Frontside Misty", src: "songs/frontsideMisty.mp3", number: 2 },
        { title: "Shy", src: "songs/frshy.mp3", number: 1 },
        { title: "howdoumakemusic", src: "songs/howdoyoumakemusic.mp3", number: 3 },
        { title: "help (Fefi)", src: "songs/help.mp3", number: 4 },
        { title: "I <3 You", src: "songs/iloveyou.mp3", number: 2 },
        { title: "Brenn", src: "songs/imback.mp3", number: 1 },
        { title: "Music Box", src: "songs/MusicBox.mp3", number: 3 },
        { title: "Good Job Team", src: "songs/newloopgoodjobteam.mp3", number: 2 },
        { title: "Princess", src: "songs/princess.mp3", number: 1 },
        { title: "Projec", src: "songs/projec.mp3", number: 3 },
        { title: "Sleepy Head", src: "songs/sleepyhead.mp3", number: 4 },
        { title: "Brick (Smoke55)", src: "songs/smoke.mp3", number: 3 },
        { title: "New Drum (Smoke55)", src: "songs/smokedrum.mp3", number: 2 },
        { title: "55 (Vo21amo)", src: "songs/vo21amoloop.mp3", number: 1 },
        { title: "What2", src: "songs/whadafuk.mp3", number: 3 },
        { title: "Wheneverver (Vo21amo)", src: "songs/wheneverever.mp3", number: 1 },
        { title: "XCXV2", src: "songs/XCXV2.mp3", number: 2 }
    ];
